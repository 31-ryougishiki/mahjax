...
1. **Data Collection:** Collecting gameplay data using a rule-based agent ([`collect_offline_data.py`](https://github.com/nissymori/mahjax/blob/main/examples/no_red/collect_offline_data.py).
2. **Behavior Cloning (BC):** Training a baseline model using supervised learning ([`bc.py`](https://github.com/nissymori/mahjax/blob/main/examples/no_red/bc.py).
3. **Reinforcement Learning (RL):** Training a PPO agent with regularization towards the BC model ([`ppo_with_reg.py`](https://github.com/nissymori/mahjax/blob/main/examples/no_red/ppo_reg.py).
...
- **Network Architecture:** Refer to [`networks.py`](https://github.com/nissymori/mahjax/blob/main/examples/no_red/network.py) for details.
